...
public class BandCamp {
    ...
    public static User getUser(String artist) throws UnsupportedEncodingException {
        ...
        uriBuilder.append("http://api.bandcamp.com/api/band/3/search?");
        uriBuilder.append("key=" + "vatnajokull");
        uriBuilder.append("&name=" + URLEncoder.encode(artist,"UTF-8"));
        uriBuilder.append("&debug");
