package com.curlymo.bandsaround.songkick.api;
...
import com.curlymo.bandsaround.songkick.api.helper.ArtistResultsPage;
import com.curlymo.bandsaround.songkick.api.helper.CalendarResultsPage;
import com.curlymo.bandsaround.songkick.api.helper.EventResultsPage;
import com.curlymo.bandsaround.songkick.api.helper.LocationResultsPage;
import com.curlymo.bandsaround.songkick.api.helper.ResultsPage;
import com.curlymo.bandsaround.songkick.api.helper.SingleEventResultsPage;
...
public class Songkick {
	...
	private List<? extends Object> getSinglePage(String url, Class<? extends ResultsPage> parsingClass, int page) throws IOException {
		...
		ResultsPage rp = mapper.readValue(reader, parsingClass);
